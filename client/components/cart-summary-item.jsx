  ...
  return (
    <div className="cartItemContainer d-flex flex-wrap justify-content-center border-bottom mb-2">
      ...
      <div className="d-flex flex-column p-2 col-md-7 mt-2">
        ...
        <div className="cartItemPriceQtyContainer d-flex mt-3 pr-3">
          ...
          <div
            className="removeBtnContainer d-flex justify-content-center align-items-center ml-lg-5 ml-md-4 ml-2"
            onClick={() => props.onDeleteCartItem(props.item)} >
            <h6 className="removeBtn btn btn-link py-0 m-0">Delete</h6>
          </div>
          <div className="cartItemPriceContainer d-flex justify-content-center align-items-center ml-auto">
